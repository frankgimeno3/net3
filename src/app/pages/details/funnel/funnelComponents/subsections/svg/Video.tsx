  ...
  >
    ...
    <g id="SVGRepo_iconCarrier">
      <path
        ...
        fill="#ffffff"
      ></path>
      <path d="M10.5 2.5L7 8" stroke="#ffffff" strokeWidth="1.5" strokeLinecap="round"></path>
      <path d="M17 2.5L13.5 8" stroke="#ffffff" strokeWidth="1.5" strokeLinecap="round"></path>
      <path
