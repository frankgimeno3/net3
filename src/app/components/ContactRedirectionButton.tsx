...
const ContactRedirectionButton: FC<ContactRedirectionButtonProps> = ({ lang }) => {
  ...
  return (
    <button
      ...
      className="items-center group rounded-full shadow-xl text-white bg-white bg-opacity-20 hover:bg-opacity-30 text-md py-3 px-3 flex items-center  py-auto"
    >
      <svg
        xmlns="http://www.w3.org/2000/svg"
        className="w-8 h-8 fill-white  hover:mx-3 transition-all duration-700 ease-in-out"
        viewBox="0 0 24 24"
      >
