...
const ContactRedirectionButton: FC<ContactRedirectionButtonProps> = ({ lang }) => {
  ...
  return (
    <button
      ...
      className="items-center group rounded-full shadow-xl text-gray-900 bg-gray-100 py-4  text-md px-4 flex items-center mb-4"
      >
      <svg
        xmlns="http://www.w3.org/2000/svg"
        className="w-8 h-8 fill-gray-500   transition-all duration-700 ease-in-out"
        viewBox="0 0 24 24"
      >
      ...
      <span
        className="max-w-0 text-gray-500 h-8 pt-1 hover:pl-1 opacity-0 overflow-hidden group-hover:max-w-xs group-hover:ml-1 group-hover:opacity-100 transition-all duration-700 ease-in-out"
      >
