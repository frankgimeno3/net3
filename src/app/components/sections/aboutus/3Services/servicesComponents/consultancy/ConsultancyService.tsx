  ...
  return (
    <div className="flex flex-col max-w-5xl mx-auto py-36 px-6">
      ...
      <p className="text-lg leading-relaxed mb-6">
        ...
        <span className="font-bold text-indigo-600"> {content.paragraph_2.key_span_2} </span>
        {content.paragraph_2.key_3}
      </p>

      <p className="text-lg leading-relaxed mb-12">
        {content.paragraph_3.key_1}
        <span className="font-bold text-indigo-600"> {content.paragraph_3.key_span_1} </span>
